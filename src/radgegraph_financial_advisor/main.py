...
class FinancialAdvisor:
    ...
    def print_recommendations(self, results: Dict[str, Any]) -> None:
        ...
        """
        print("\n" + "=" * 80)
        print("RADGEGRAPH FINANCIAL ADVISOR - ANALYSIS RESULTS")
        print("=" * 80)
    ...
    def print_multi_asset_plan(self, plan: Dict[str, Any]) -> None:
        ...
        print("\n" + "=" * 80)
        print("RADGEGRAPH MULTI-ASSET ALLOCATION PLAN")
        print("=" * 80)
...
async def main():
    """
    Command-line interface for RADGEGRAPH Financial Advisor.
    """
    parser = argparse.ArgumentParser(
        description="RADGEGRAPH Financial Advisor - AI-powered investment analysis"
    )
    parser.add_argument(
...
def cli_main():
    """
    Entry point for the radgegraph command-line script.
    """
    asyncio.run(main())
